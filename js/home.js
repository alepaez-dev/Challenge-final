...
let post_1 = {
  ...
  dateCreated: new Date("2011-03-02").toISOString().slice(0, 10),
  minsToRead: "1",
...
let post_2 = {
  ...
  dateCreated: new Date("2019-02-02").toISOString().slice(0, 10),
  minsToRead: "12",
  tag: "tag",
...
let post_5 = {
  ...
  dateCreated: new Date("2013-03-02").toISOString().slice(0, 10),
  minsToRead: "5",
  tag: "github #markdown #webdev #readme",
  title: "I wrote a free book on React.js and just made it available on GitHub",
  urlAuthor:
